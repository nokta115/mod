...
public class CursedLeavesBlock extends MyfirstmodModElements.ModElement {
	@ObjectHolder("myfirstmod:cursed_leaves")
	public static final Block block = null;
	public CursedLeavesBlock(MyfirstmodModElements instance) {
		super(instance, 12);
	}
