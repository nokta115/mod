...
public class CursedGrassBlock extends MyfirstmodModElements.ModElement {
	@ObjectHolder("myfirstmod:cursed_grass")
	public static final Block block = null;
	public CursedGrassBlock(MyfirstmodModElements instance) {
		super(instance, 3);
	}
