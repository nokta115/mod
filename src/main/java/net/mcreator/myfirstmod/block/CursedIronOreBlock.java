...
public class CursedIronOreBlock extends MyfirstmodModElements.ModElement {
	@ObjectHolder("myfirstmod:cursed_iron_ore")
	public static final Block block = null;
	public CursedIronOreBlock(MyfirstmodModElements instance) {
		super(instance, 4);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cursed_iron_ore");
		}
