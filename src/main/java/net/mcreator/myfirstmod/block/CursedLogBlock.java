...
public class CursedLogBlock extends MyfirstmodModElements.ModElement {
	@ObjectHolder("myfirstmod:cursed_log")
	public static final Block block = null;
	public CursedLogBlock(MyfirstmodModElements instance) {
		super(instance, 1);
	}
