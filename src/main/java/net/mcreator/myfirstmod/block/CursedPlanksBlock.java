...
public class CursedPlanksBlock extends MyfirstmodModElements.ModElement {
	@ObjectHolder("myfirstmod:cursed_planks")
	public static final Block block = null;
	public CursedPlanksBlock(MyfirstmodModElements instance) {
		super(instance, 2);
	}
